...
const { getAllStudent, createStudent, getSingelStudent, editStudent, studentDataStore, deleteStudent, updateStudent, getAllUnverifiedStudent, verifyAccount, verifyStudentByPhone, verifymessage } = require('../controllers/studentsControllers');
...
router.post('/phoneverifyed/:id', verifymessage);
